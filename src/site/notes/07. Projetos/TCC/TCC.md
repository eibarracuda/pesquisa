---
{"dg-publish":true,"permalink":"/07-projetos/tcc/tcc/","created":"2023-10-10T12:59:24.595-03:00","updated":"2023-10-11T08:38:45.437-03:00"}
---
...
flowchart TB; 
	...
	A[[Conservador-Restaurador]]:::idper	
    
classDef idper stroke:#a58ea9,stroke-width:2px,color:#a58ea9
```
...
![mapa de palavras.jpg](/img/user/XX%20-%20Anexos/mapa%20de%20palavras.jpg)
...
flowchart TB
	...
	direction LR
	001[[Identidade profissional]]:::idper
	
		subgraph  
			direction LR
			000[a]-- indica uma ação --- 002[b]
		end
	end
...
classDef idper stroke:#a58ea9,stroke-width:2px,color:#a58ea9
classDef manif stroke:#ed8743,stroke-width:2px,color:#ed8743
classDef saber stroke:#afcc74,stroke-width:2px, color:#afcc74
```
###### Elaboração própria. Fonte: BOJANOSKI, MICHELON & BEVILACQUA, 2017a.
...
flowchart TB
	...
	direction TB
	    A[[Conservador-Restaurador]]:::idper	
	    C[???]:::manif
	    d[Ciência da Conservação]:::saber
			d---A
		    A-- Restaura ---C
		    A-- Preserva ---C
		    A-- Conserva ---C
...
flowchart TB
	...
	001[[Identidade profissional]]:::idper
	003[Campo do saber]:::saber
	004[Manifestação cultural]:::manif
...
Imagem 1 - Mapa
![Mapa mental - Relatorios dos grupos de discussãoa.png](/img/user/XX%20-%20Anexos/TCC/Mapa%20mental%20-%20Relatorios%20dos%20grupos%20de%20discuss%C3%A3oa.png)
...
![Pasted image 20231008155914](/img/user/XX - Anexos/Pasted image 20231008155914.png)
...
![Pasted image 20231008212952](/img/user/XX - Anexos/Pasted image 20231008212952.jpg)
...
![Pasted image 20231008212941](/img/user/XX - Anexos/Pasted image 20231008212941.jpg)
Fonte: Muro de Athos Bulcão deve ser restaurado até fim de janeiro - 16/01/23 - YouTube. Disponível em: https://www.youtube.com/watch?v=Q-p7vjYwf18. Acesso em: 08/10/2023)
###### Contexto histórico
![Pasted image 20231008212922](/img/user/XX - Anexos/Pasted image 20231008212922.jpg)
Fonte: Muro de Athos Bulcão deve ser restaurado até fim de janeiro - 16/01/23 - YouTube. Disponível em: https://www.youtube.com/watch?v=Q-p7vjYwf18. Acesso em: 08/10/2023)
