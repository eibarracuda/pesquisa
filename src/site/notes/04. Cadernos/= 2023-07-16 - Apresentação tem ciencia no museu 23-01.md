---
{"dg-publish":true,"permalink":"/04-cadernos/2023-07-16-apresentacao-tem-ciencia-no-museu-23-01/","title":"Apresentação tem ciencia no museu 23-01","tags":["🧠️/📝️/🌱️"],"created":"2023-07-16T12:23:10.537-03:00","updated":"2023-08-07T11:52:41.017-03:00"}
---
...
![Pasted image 20230716122351.png](/img/user/XX%20-%20Anexos/Pasted%20image%2020230716122351.png)
#  Tem Ciência no Museu?   |   Retrospectiva 2023/01
...
### Seleção de dois bolsistas estudantes de graduação da área de Comunicação Social, com **planos de trabalho voltados para divulgação** das ações e agendas do projeto e contato com o público;
...
A{Plano de divulgação}:::atividadesPrevistas
id8([Contato com o público]):::atividadesPrevistas
...
Este fluxo considera os canais de comunicação listados no tópico A.1.5
...
- Orquestrar como adquirir os dados dos eventos 
	- scraper para planilha?
- Agenda Cientifico-Cultural
	- Criação de legendas e modelos ao subir estes eventos
	- Fazer um documento guia
	- ![Pasted image 20230716201922.png](/img/user/XX%20-%20Anexos/Pasted%20image%2020230716201922.png)
...
> Sendo executado, porém com alguns problemas
  

  ```mermaid 
  graph LR
accTitle: Representação visual de problemas neste fluxo de trabalho
accDescr { Apresentação visual de várias etapas e sugestões para produção da newsletter}
  

B[Reportagens]
C[Vídeos]
D[Materiais de divulgação]:::emExecucao
E[Redes Sociais]
F[Murais de escolas]:::nope
G[Sobre o lançamento<br> de exposições]
H[Sobre o alcance<br> das exposições]
I(Necessidade de imagens)
J[Dependencia de colaboração dos espaços]:::nope
K(Necessidade de relato)
L[Dependencia de eventos existirem<br>para serem divulgados]:::nope


subgraph A1 ["Produção de Conteudo"]
direction LR
subgraph AA1 ["Conteudos"]
direction RL
B 
C 
D
end
subgraph AA2 ["Dependencias"]
direction RL
K --- J
I --- J
L
